...
public struct BTPayPalMessagingData {

    public let configurationEnvironment: String?
    public let configurationClientID: String

    public let offerType: BTPayPalMessagingResponseOfferType
    public let productGroup: BTPayPalMessageResponseProductGroup
    ...
    public init(
        ...
        offerType: BTPayPalMessagingResponseOfferType,
        productGroup: BTPayPalMessageResponseProductGroup,
        ...
        self.configurationClientID = configurationClientID
